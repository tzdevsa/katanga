            ...
            <Grid item xs={12} sm={5}>
              <Container>
                <CardContent>
                  ...
                  >
                    Start Your Enrollment Process at {organisation?.name} today!
                  </Typography>
                </CardContent>
                <CardContent>
                  <Typography variant="body2" component="h2" align="left" gutterBottom>
                    <ArrowRightIcon fontSize="small" color="primary" />Complete and submit the form.
                  </Typography>
                  <Typography variant="body2" component="h2" align="left" gutterBottom>
                    <ArrowRightIcon fontSize="small" color="primary" />Take note of the application number.
                  </Typography>
                  <Typography variant="body2" component="h2" align="left" gutterBottom>
                    <ArrowRightIcon fontSize="small" color="primary" />Attend an entrance interview.
                  </Typography>
                  <Typography variant="body2" component="h2" align="left" gutterBottom>
                    <ArrowRightIcon fontSize="small" color="primary" />Receive your admission letter.
                  </Typography>
                  <Typography variant="body2" component="h2" align="left" gutterBottom>
                    <ArrowRightIcon fontSize="small" color="primary" />Prepare for enrollment.
                  </Typography>
                </CardContent>
              </Container>
            </Grid>
